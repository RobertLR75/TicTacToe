# frontend-game-state-client Specification

## Purpose
Defines the typed HttpClient used by the frontend to communicate with GameStateService for game-state reads and move submission.
