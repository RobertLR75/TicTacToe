# list-games Specification

## Purpose
Defines the behavior of the `GET /api/games` list endpoint, including PostgreSQL-based retrieval, filter and paging semantics, and dependency boundaries.
