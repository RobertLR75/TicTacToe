...
Define resilient startup behavior for notification persistence so `GameNotificationService` stays available, reports dependency readiness accurately, and recovers automatically after transient PostgreSQL failures.
